---
title: Wireless Technology for Monitoring and Improving Performance in S&C
author: Chris Bailey, PhD, CSCS*D, RSCC
date: '2019-07-01'
slug: wireless-technology-for-monitoring-and-improving-performance-in-s-c
categories:
  - Athlete Monitoring
tags:
  - Athlete Monitoring
...
knitr::include_graphics("https://i.ibb.co/ymTpHWW/Data-Return-Timeline.png")
...
knitr::include_graphics("https://i.ibb.co/qdnQLcP/PrePost1.png")
knitr::include_graphics("https://i.ibb.co/2W68NjR/PrePost2.png")
```
...
knitr::include_graphics("https://i.ibb.co/2MVs90z/Not-Pre-Post.png")
```
<center><font size="2">cbaileyphd.com</font></center><br>
...
```{r, echo=FALSE, fig.align='center', out.width = "70%"}
knitr::include_graphics("https://i.ibb.co/bd1DHmN/Optimal-Response.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width = "70%"}
knitr::include_graphics("https://i.ibb.co/dfztHhR/Small-Stimulus.png")
knitr::include_graphics("https://i.ibb.co/f2xg9Bh/Large-Stimulus.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width = "70%"}
knitr::include_graphics("https://i.ibb.co/CM5SvMH/Repeat-Large-Stimulus.png")
```
...
```{r,  echo=FALSE, fig.align='center', out.width = "80%"}
knitr::include_graphics("https://i.ibb.co/fn125CW/Corplot.png")
```
...
```{r, echo=FALSE, fig.show = "hold", out.width = "85%"}
knitr::include_graphics("https://i.ibb.co/6rBgXds/sRPETL.png")
knitr::include_graphics("https://i.ibb.co/yg3QQX2/PMS.png")
knitr::include_graphics("https://i.ibb.co/MnxP7x6/Sleep.png")
knitr::include_graphics("https://i.ibb.co/njqRGt1/Soreness.png")
```
<center><font size="2">cbaileyphd.com</font></center><br>
...
```{r,  echo=FALSE, fig.align='center', out.width = "70%"}
knitr::include_graphics("https://i.ibb.co/5Tk1nnH/DualFPs.png")
```
...
knitr::include_graphics("https://i.ibb.co/7zxbVbv/SI1.png")
knitr::include_graphics("https://i.ibb.co/DpqRcJr/SI2.png")
```
<center><font size="2">cbaileyphd.com</font></center><br>
